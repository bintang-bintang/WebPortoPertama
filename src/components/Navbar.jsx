...
const Navbar = () => {
    ...
    const setelahScroll = "z-[100] fixed top-[2%] left-1/2 transform -translate-x-1/2 w-[75%] rounded-[8px] font-primary font-semibold py-[1.2%] px-[4%] text-putih flex justify-between items-center bg-main drop-shadow-md border border-abusecond";
    ...
    return (
        <motion.div
            ...
            animate={{
                ...
                paddingRight: scrolled ? '4%' : '12%',
                paddingLeft: scrolled ? '4%' : '12%',
        ...
        >
            <a className='cursor-pointer' href='/' >BintangAji</a>
            <ul className="flex gap-4 md:gap-1 xl:gap-4">
                {scrolled ? (
                    <li>
                    ...
                    <>
                        <li className='font-normal md:text-[12px] xl:text-[1rem]'><a id='home' href="/">Home</a></li>
                        <li className='font-normal md:text-[12px] xl:text-[1rem]'><a id='about' href="/about">About</a></li>
                        <li className='font-normal md:text-[12px] xl:text-[1rem]'><a id='project' href="project">Project</a></li>
                    </>
                )}
            </ul>
        </motion.div>
