...
const Card = ({ gambar, judul, paragraf, skills, link }) => {
    ...
    return (
        <div className="bg-main w-[29em] h-fit rounded-[8px] border border-abusecond hover:scale-[1.015] transition-transform ease-in-out duration-[245ms] group shadow-xl">
            <a className='cursor-pointer' href={link ? (link):(null)} target='_blank'>
                ...
                <div className="font-primary text-putih bg-second w-auto h-min px-8 py-3 rounded-b-[8px] flex flex-col gap-1">
