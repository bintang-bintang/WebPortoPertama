    ...
    <>
      ...
      <div className=" font-primary text-putih px-[12%] py-[4%] bg-abumain/80 w-[100%] h-max overflow-x-hidden overflow-y-hidden shadow-[rgba(58,79,100,0.5)_0px_-4px_24px_0px]">
        ...
        <div className="flex flex-wrap items-center lg:justify-center xl:justify-between gap-y-5">
          ...
          <Card link="https://github.com/bintang-bintang/TeknoHub" gambar={proyek2} judul="Toko Elektronik Landing Page" paragraf="Slicing desain landing page dari figma ke ReactJS dengan Tailwind css" />
          <Card link="https://github.com/bintang-bintang/WebPortoPertama" gambar={proyek3} judul="Website Portofolio" paragraf="Pengembangan website portofolio dengan menggunakan ReactJS, Tailwind CSS, dan Framer Motion" />
